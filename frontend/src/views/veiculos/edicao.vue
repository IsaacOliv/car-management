            ...
            <form action="">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="modelo" max="30" required v-model="dados.veiculo.modelo">
                        <span class="erro" v-if="dados.errors.modelo">{{ dados.errors.modelo[0] }}</span>
                    </div>
                    <div class="col-md-6">
                        <label for="placa" class="form-label">Placa:</label>
                        <input type="text" class="form-control" id="placa" max="30" required v-model="dados.veiculo.placa">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="dataAquisicao" required v-model="dados.veiculo.dataAquisicao">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="id_acessibilidade" id="acessibilidade" v-model="dados.veiculo.id_acessibilidade">
